      ...
      <div class="bg-gray-800 rounded-lg shadow p-4">
        <div class="flex gap-6 items-start">
          <div class="w-24 h-24 flex-shrink-0 overflow-hidden rounded">
            <img src="https://placehold.co/155x220?text=Book" alt="Capa do Livro" class="object-cover w-full h-full" />
          </div>
          <div class="flex flex-col h-full">
            <div class="flex-1">
              <h2 class="text-xl font-bold text-gray-300"><?=$livro['titulo']?></h2>
